...
exports.applyTemplate = exports.validateResponseString = exports.createLLIssue = exports.createIssue = exports.createIssue1 = exports.toIssue = exports.getMediaType = exports.isXML = exports.isJson = exports.ExampleAndDefaultValueValidator = exports.getHumanReadableNodeName = exports.parameterPropertyToName = exports.typeToName = exports.UrlParameterNameValidator = exports.isValid = exports.validate = exports.validateBasic = exports.validateBasicFlat = exports.typeOfContainingTemplate = exports.RESERVED_TEMPLATE_PARAMETERS = void 0;
            ...
            if (typeof values == 'string') {
                if (values != vl) {
                    if (vl && (vl.indexOf("x-") == 0) && pr.nameId() == universes.Universe08.AbstractSecurityScheme.properties.type.name) { //Some magic I copied a from a couple of lines below @Denis
                        ...
                        v.accept(createIssue1(messageRegistry.INVALID_VALUE, { iValue: vl, aValues: "'" + values + "'" }, node));
                    }
                }
            }
                ...
                if (!_.find(values, function (x) { return x == vl; })) {
                    if (vl && (vl.indexOf("x-") == 0) && pr.nameId() == universes.Universe08.AbstractSecurityScheme.properties.type.name) { //FIXME move to def system
                        ...
                        v.accept(createIssue1(messageRegistry.INVALID_VALUE, { iValue: vl, aValues: values.map(function (x) { return "'" + x + "'"; }).join(", ") }, node));
                    }
                }
            }
        }
